...
<form action="{{url('/web/update/'.$res->web_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
@csrf
<!-- {{csrf_field()}}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$res->web_name}}" name="web_name" id="firstname" 
           placeholder="请输入网站名称">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="{{$res->web_dizhi}}" name="web_dizhi" id="firstname" 
           placeholder="请输入网站网址">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="web_man" value="{{$res->web_man}}" id="firstname" 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      @if($res->web_logo)<img src="{{env('UPLOADS_URL')}}{{$res->web_logo}}" width="100">@endif
    </div>
  </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <textarea type="text" class="form-control" name="web_desc" id="lastname" 
           placeholder="请输入网站介绍">{{$res->web_desc}}</textarea>
      </div>
    </div>
    <div class="form-group">
